...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app_user.profile.form.type' => 'getAppUser_Profile_Form_TypeService',
    ...
    /**
     * Gets the 'app_user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getAppUser_Profile_Form_TypeService()
    {
        return $this->services['app_user.profile.form.type'] = new \AppBundle\Form\ProfileFormType('AppBundle\\Entity\\User');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'join_uss2', 'user' => 'root', 'password' => 'coderslab', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_13d0317ad8a7e6ef7d4efc58332d7d65d9885c5eb6dc833a4a7d2b1acd85539f');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/photo/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/event/');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/crew/');
        ...
        $t->setOptions(array('default_target_path' => '/index', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4dcf8a0fb965680ab7fbbcdf9ec85cdea5ec791b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '4dcf8a0fb965680ab7fbbcdf9ec85cdea5ec791b',
            'locale' => 'en',
            ...
            'kernel.secret' => '4dcf8a0fb965680ab7fbbcdf9ec85cdea5ec791b',
