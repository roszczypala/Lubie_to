 ...
 */
class Crew extends \AppBundle\Entity\Crew implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'accepted', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'users', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'events', '' . "\0" . 'AppBundle\\Entity\\Crew' . "\0" . 'photo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Crew $proxy) {
    ...
    public function setAccepted($accepted)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAccepted', array($accepted));
    ...
    public function getAccepted()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAccepted', array());
    ...
    public function getActiveEvents()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActiveEvents', array());

        return parent::getActiveEvents();
    }
